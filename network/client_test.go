...
func TestClientDo(t *testing.T) {
	...
	statusCode, statusText, _, _, _ := c.doJSON("test/auth", "GET", http.StatusOK, nil, nil)
	...
	statusCode, statusText, _, _, _ = c.doJSON("test/json", "GET", http.StatusOK, nil, &res)
	assert.Equal(t, http.StatusBadRequest, statusCode, statusText)

	statusCode, statusText, _, _, _ = c.doJSON("test/json", "GET", http.StatusOK, &req, nil)
	assert.Equal(t, http.StatusNotAcceptable, statusCode, statusText)

	statusCode, statusText, _, _, _ = c.doJSON("test/json", "GET", http.StatusOK, nil, nil)
	assert.Equal(t, http.StatusBadRequest, statusCode, statusText)

	statusCode, statusText, _, _, _ = c.doJSON("test/json", "GET", http.StatusOK, &req, &res)
...
func TestClientInvalidSSL(t *testing.T) {
	...
	statusCode, statusText, _, _, _ := c.doJSON("test/ok", "GET", http.StatusOK, nil, nil)
...
func TestClientTLSCAFile(t *testing.T) {
	...
	statusCode, statusText, tlsData, _, _ := c.doJSON("test/ok", "GET", http.StatusOK, nil, nil)
	assert.Equal(t, http.StatusOK, statusCode, statusText)
...
func TestClientHandleCharsetInContentType(t *testing.T) {
	...
	statusCode, statusText, _, _, _ := c.doJSON("with-charset", "GET", http.StatusOK, nil, &res)
	assert.Equal(t, http.StatusOK, statusCode, statusText)

	statusCode, statusText, _, _, _ = c.doJSON("without-charset", "GET", http.StatusOK, nil, &res)
	assert.Equal(t, http.StatusOK, statusCode, statusText)

	statusCode, statusText, _, _, _ = c.doJSON("without-json", "GET", http.StatusOK, nil, &res)
	assert.Equal(t, -1, statusCode, statusText)

	statusCode, statusText, _, _, _ = c.doJSON("invalid-header", "GET", http.StatusOK, nil, &res)
	assert.Equal(t, -1, statusCode, statusText)
}
