...
func (a *azureAdapter) GetDownloadURL(ctx context.Context) *url.URL {
	return a.presignURL(http.MethodGet)
}

func (a *azureAdapter) GetUploadURL(ctx context.Context) *url.URL {
...
func (a *azureAdapter) GetGoCloudURL(ctx context.Context) *url.URL {
