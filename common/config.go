...
type DockerConfig struct {
	...
	ServicesLimits              int               `toml:"services_limit,omitzero" json:"services_limit" long:"services-limit" env:"DOCKER_SERVICES_LIMIT" description:"The maximum amount of services allowed"`
