...
type DockerConfig struct {
	...
	HelperImageRegistry        string             `toml:"helper_image_registry,omitempty" json:"helper_image_registry" long:"helper-image-registry" env:"DOCKER_HELPER_IMAGE_REGISTRY" description:"[ADVANCED] Override the default registry used to pull the helper image"`
...
type KubernetesConfig struct {
	...
	HelperImageRegistry                               string                             `toml:"helper_image_registry,omitempty" json:"helper_image_registry" long:"helper-image-registry" env:"KUBERNETES_HELPER_IMAGE_REGISTRY" description:"[ADVANCED] Override the default registry used to pull the helper image"`
