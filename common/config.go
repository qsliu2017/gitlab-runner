...
type KubernetesConfig struct {
	...
	HugePages2MiLimit                                 string                       `toml:"hugepages_2mi_limit,omitempty" json:"hugepages_2mi_limit" long:"hugepages-2mi-limit" env:"KUBERNETES_HUGEPAGES_2MI_LIMIT" description:"The amount of hugepages-2mi allocated to build containers"`
	HugePages2MiLimitOverwriteMaxAllowed              string                       `toml:"hugepages_2mi_limit_overwrite_max_allowed,omitempty" json:"hugepages_2mi_limit_overwrite_max_allowed" long:"hugepages-2mi-limit-overwrite-max-allowed" env:"KUBERNETES_HUGEPAGES_2MI_LIMIT_OVERWRITE_MAX_ALLOWED" description:"If set, the max amount the hugepages-2mi limit can be set to. Used with the KUBERNETES_HUGEPAGES_2MI_LIMIT variable in the build."`
	...
	ServiceHugePages2MiLimit                          string                       `toml:"service_hugepages_2mi_limit,omitempty" json:"service_hugepages_2mi_limit" long:"service-hugepages-2mi-limit" env:"KUBERNETES_HUGEPAGES_2MI_MEMORY_LIMIT" description:"The amount of hugepages-2mi allocated to build service containers"`
	ServiceHugePages2MiLimitOverwriteMaxAllowed       string                       `toml:"service_hugepages_2mi_limit_overwrite_max_allowed,omitempty" json:"service_hugepages_2mi_limit_overwrite_max_allowed" long:"service-hugepages-2mi-limit-overwrite-max-allowed" env:"KUBERNETES_SERVICE_HUGEPAGES_2MI_LIMIT_OVERWRITE_MAX_ALLOWED" description:"If set, the max amount the service hugepages-2mi limit can be set to. Used with the KUBERNETES_SERVICE_HUGEPAGES_2MI_LIMIT variable in the build."`
	...
	HelperHugePages2MiLimit                           string                       `toml:"helper_hugepages_2mi_limit,omitempty" json:"helper_hugepages_2mi_limit" long:"helper-hugepages-2mi-limit" env:"KUBERNETES_HELPER_HUGEPAGES_2MI_LIMIT" description:"The amount of hugepages-2mi allocated to build helper containers"`
	HelperHugePages2MiLimitOverwriteMaxAllowed        string                       `toml:"helper_hugepages_2mi_limit_overwrite_max_allowed,omitempty" json:"helper_hugepages_2mi_limit_overwrite_max_allowed" long:"helper-hugepages-2mi-limit-overwrite-max-allowed" env:"KUBERNETES_HELPER_HUGEPAGES_2MI_LIMIT_OVERWRITE_MAX_ALLOWED" description:"If set, the max amount the helper hugepages-2mi limit can be set to. Used with the KUBERNETES_HELPER_HUGEPAGES_2MI_LIMIT variable in the build."`
