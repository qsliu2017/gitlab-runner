...
type RunnerSettings struct {
	...
	SkipCleanup        bool `toml:"skip_cleanup,omitempty" json:"skip_cleanup" long:"skip-cleanup" description:"When set to true Runner will not perform cleanup (use to DEBUG builds when executed locally)"`
