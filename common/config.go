...
type DockerConfig struct {
	...
	Windows                    DockerWindowsConfig `toml:"windows"`
}

type DockerWindowsConfig struct {
	HelperImageFlavor string `toml:"helper_image_flavor,omitempty" json:"helper_image_flavor" long:"helper-image-flavor" env:"DOCKER_WINDOWS_HELPER_IMAGE_FLAVOR" description:"Specify the windows server flavor that you want to use for the helper image, for example nanoserver1809. Currently the available flavors are nanoserver1809 and nanoserver1803"`
}
