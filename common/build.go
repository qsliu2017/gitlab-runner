...
// GetURLInsteadOfArgs rewrites a plain HTTPS base URL and the most commonly used
// SSH/Git protocol URLs into an HTTPS URL with injected job token auth, and returns
// an array of strings to pass as options to git commands.
// This is currently not aware of custom SSH ports or other edge cases.
