...
The [NTFSSecurity](https://archive.codeplex.com/?p=ntfssecurity) PowerShell module provides
...
Windows' CMD terminal (before Win10 [version 1511](https://docs.microsoft.com/en-us/windows/console/console-virtual-terminal-sequences#extended-colors))
