...
| `FF_GITLAB_REGISTRY_HELPER_IMAGE` | `true` | **{dotted-circle}** No |  | Use GitLab Runner helper image for the executors for Docker and Kubernetes from `registry.gitlab.com` instead of Docker Hub |
