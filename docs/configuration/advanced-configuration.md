...
named `DOCKER_AUTH_CONFIG`. You can set the variable in the project's CI/CD settings as [type `File`](https://docs.gitlab.com/ee/ci/variables/#cicd-variable-types)
