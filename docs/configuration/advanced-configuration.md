...
> - Requires Elasticsearch or Elastic Cloud using Elasticsearch 7.x or later.

If the machine/container that is running the job has an attached instance of [Suricata](https://suricata-ids.org) that monitors the job's network traffic, GitLab Runner can query the Suricata log from Elasticsearch or Elastic Cloud when the job completes.

Suricata must be configured to output its log in [Eve JSON format](https://suricata.readthedocs.io/en/suricata-5.0.1/output/eve/eve-json-output.html). After it's configured, the Eve log must be pushed to an instance of Elasticsearch or Elastic Cloud using the [Suricata file beat module](https://www.elastic.co/guide/en/beats/filebeat/current/filebeat-module-suricata.html). Additonally, the hostname for the runner instance must be added to Filebeat configuration as a processor so that it is added to all events generated by the Suricata module. This allows the referee to isolate the Suricata logs generated during the job's timeframe. Here is an example Filebeat configuration that enables the Suricata module and adds this field:
...
- add_fields:
    fields:
      hostname: "runner-1234"
```

After the network referee receives the Suricata log from Elastic Cloud, it is uploaded as a job artifact and can be used for network activity analysis. Here is an example of a single event's output from Suricata in the job artifact log:

```json
{
  "_index": "suricata-000001",
  "_type": "_doc",
  "_id": "otxU5XEBuPRvUi_dhps9",
  "_version": 1,
  "_score": null,
  "_source": {
    "agent": {
      "hostname": "packer-5eab3d23-96e1-e28a-2427-53e7ffce2544.c.gitlab-security.in",
      "id": "5b4d86fd-9153-4969-a67a-407beef8d75c",
      "type": "filebeat",
      "ephemeral_id": "93a36914-abb6-4917-8e22-fccd9c44d200",
      "version": "7.6.2"
    },
    "log": {
      "file": {
        "path": "/var/log/host/suricata/eve.json"
      },
      "offset": 517326
    },
    "dns": {
      ...
      "question": {
        "registered_domain": "found.io",
        "name": "3e0a9e43daeb4e79bdd2353c82a3aa29.us-east-1.aws.found.io",
        "type": "AAAA"
      },
      "answers": [
        {
          "data": "proxy-production-v4-1947559340.us-east-1.elb.amazonaws.com",
          "name": "3e0a9e43daeb4e79bdd2353c82a3aa29.us-east-1.aws.found.io",
          "type": "CNAME",
          "ttl": 59
        }
    ...
    "network": {
      "community_id": "1:didsyqVMeS9+HoFOCNvrxn69ySE=",
      "transport": "udp"
    },
    "input": {
      "type": "log"
    },
    "@timestamp": "2020-05-05T14:54:12.036Z",
    "ecs": {
      "version": "1.4.0"
    },
    "service": {
    ...
    "host": {
      "name": "packer-5eab3d23-96e1-e28a-2427-53e7ffce2544.c.gitlab-security.in"
    },
    "suricata": {
      "eve": {
        "in_iface": "ens4v1",
        "event_type": "dns",
        "flow_id": 271010256587266,
        "dns": {
          "rrname": "3e0a9e43daeb4e79bdd2353c82a3aa29.us-east-1.aws.found.io",
          "rcode": "NOERROR",
          "id": 41924,
          "type": "answer",
          "authorities": [
            {
              "rrname": "us-east-1.elb.amazonaws.com",
              "ttl": 59,
              "rrtype": "SOA"
            }
          ],
    ...
    "event": {
      "original": "{\"timestamp\":\"2020-05-05T14:54:12.036151+0000\",\"flow_id\":271010256587266,\"in_iface\":\"ens4v1\",\"event_type\":\"dns\",\"src_ip\":\"10.142.0.47\",\"src_port\":39410,\"dest_ip\":\"169.254.169.254\",\"dest_port\":53,\"proto\":\"UDP\",\"dns\":{\"version\":2,\"type\":\"answer\",\"id\":41924,\"flags\":\"8180\",\"qr\":true,\"rd\":true,\"ra\":true,\"rrname\":\"3e0a9e43daeb4e79bdd2353c82a3aa29.us-east-1.aws.found.io\",\"rrtype\":\"AAAA\",\"rcode\":\"NOERROR\",\"answers\":[{\"rrname\":\"3e0a9e43daeb4e79bdd2353c82a3aa29.us-east-1.aws.found.io\",\"rrtype\":\"CNAME\",\"ttl\":59,\"rdata\":\"proxy-production-v4-1947559340.us-east-1.elb.amazonaws.com\"}],\"grouped\":{\"CNAME\":[\"proxy-production-v4-1947559340.us-east-1.elb.amazonaws.com\"]},\"authorities\":[{\"rrname\":\"us-east-1.elb.amazonaws.com\",\"rrtype\":\"SOA\",\"ttl\":59}]}}",
      "created": "2020-05-05T14:54:12.997Z",
      "kind": "event",
      "module": "suricata",
    ...
    "fields": {
      "hostname": "runner-6qdz1ad-auto-scale-runner-1588690307-05640573"
    }
  },
  "fields": {
    "event.created": [
      "2020-05-05T14:54:12.997Z"
    ],
    "suricata.eve.timestamp": [
      "2020-05-05T14:54:12.036Z"
    ],
    "@timestamp": [
      "2020-05-05T14:54:12.036Z"
    ]
