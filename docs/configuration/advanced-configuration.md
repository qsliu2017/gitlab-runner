...
| `powershell`  | generate Windows PowerShell Desktop script. All commands are executed in PowerShell context (default for Windows) |
| `pwsh`        | generate PowerShell Core script. All commands are executed in PowerShell context (default for Windows) |
