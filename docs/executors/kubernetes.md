...
| `helper_image_registry` | The registry used to pull the helper image. Default is `registry.gitlab.com/gitlab-org/gitlab-runner/gitlab-runner-helper`. It is however ignored when `helper_image` is also set. |
