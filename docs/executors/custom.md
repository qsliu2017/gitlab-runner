...
| `step_script_supported` | bool | ✗ | ✓ | Defines whether the driver supports and wants to use `step_script` instead of `build_script`. See the [Run](#run) section bellow to understand the difference. |
...
1. `step_*`
1. `build_script` or `step_script` (see the deprecation notice bellow)
1. `step_*`
1. `after_script`
...
NOTE:
As of GitLab Runner 14.0, `build_script` will be deprecated and migration to `step_script` should be done.
For more information about the deprecation and our rollout plan please see
[this epic](https://gitlab.com/groups/gitlab-org/-/epics/6112) and the [Config](#config) section above.
...
| `build_script` | A combination of [`before_script`](https://docs.gitlab.com/ee/ci/yaml/#before_script-and-after_script) and [`script`](https://docs.gitlab.com/ee/ci/yaml/#script). As of GitLab Runner 14.0, `build_script` will be deprecated and migration to `step_script` should be done. For more information about the deprecation and our rollout plan please see [this epic](https://gitlab.com/groups/gitlab-org/-/epics/6112). |
