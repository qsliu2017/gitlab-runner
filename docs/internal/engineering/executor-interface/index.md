...
Te two main interfaces that allow to manage executor's lifetime and job execution are:

- `common.Executor` (named `Executor` further in this document),
- `common.ExecutorProvider` (named `ExecutorProvider` further in this document).
