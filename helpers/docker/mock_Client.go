...
// ContainerExecAttach provides a mock function with given fields: ctx, _a1, options
func (_m *MockClient) ContainerExecAttach(ctx context.Context, _a1 string, options types.ExecConfig) (types.HijackedResponse, error) {
	ret := _m.Called(ctx, _a1, options)
