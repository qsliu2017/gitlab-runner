...
func (s *executor) Run(cmd common.ExecutorCommand) error {
	...
	if cmd.Predefined {
		...
		containerCommand = s.helperImage.Cmd
	}
...
func createFn() common.Executor {
	helperImage, err := helperimage.Get(common.REVISION, helperimage.Config{
