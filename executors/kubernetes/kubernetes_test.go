...
func mustCreateResourceList(t *testing.T, cpu, hugePages2Mi, memory, ephemeralStorage string) api.ResourceList {
	resources, err := createResourceList(cpu, hugePages2Mi, memory, ephemeralStorage)
	...
	}{
		{
			...
			Expected: &executor{
				...
				configurationOverwrites: &overwrites{
					namespace:       "default",
					buildLimits:     mustCreateResourceList(t, "1.5", "2Gi", "4Gi", "6Gi"),
					serviceLimits:   mustCreateResourceList(t, "100m", "100Mi", "200Mi", "1Gi"),
		...
		},
		{
			...
			Expected: &executor{
				...
				configurationOverwrites: &overwrites{
					...
					serviceLimits:   mustCreateResourceList(t, "100m", "100Mi", "200Mi", "2Gi"),
					serviceRequests: mustCreateResourceList(t, "99m", "", "5Mi", "200Mi"),
					helperLimits:    mustCreateResourceList(t, "50m", "50Mi", "100Mi", "300Mi"),
		...
		},
		{
			...
			Expected: &executor{
				...
				configurationOverwrites: &overwrites{
					...
					serviceAccount:  "a_service_account",
					buildLimits:     mustCreateResourceList(t, "1.5", "2Gi", "4Gi", "5Gi"),
